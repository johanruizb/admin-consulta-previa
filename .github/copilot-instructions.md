...
- **Skills obligatorios**: Usar `.claude/skills/` (vercel-composition-patterns, vercel-react-best-practices, vercel-react-native-skills, web-design-guidelines) para todas las consultas y solicitudes
